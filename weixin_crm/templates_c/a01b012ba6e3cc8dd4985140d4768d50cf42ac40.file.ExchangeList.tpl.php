<?php /* Smarty version Smarty-3.0-RC2, created on 2014-05-28 10:13:58
         compiled from "/web/www/yajie_weixin_crm/weixin_crm//templates/jiantang/exchange/ExchangeList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12415231253854666de4224-94567548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a01b012ba6e3cc8dd4985140d4768d50cf42ac40' => 
    array (
      0 => '/web/www/yajie_weixin_crm/weixin_crm//templates/jiantang/exchange/ExchangeList.tpl',
      1 => 1401157842,
    ),
  ),
  'nocache_hash' => '12415231253854666de4224-94567548',
  'function' => 
  array (
  ),
...
" width="80" height="80"></td>
                ...
                <td style="text-align: left;width: 30%"><?php echo $_smarty_tpl->tpl_vars['exchangeIteam']->value['exchange_summary'];?>
</td>
                <?php if ($_smarty_tpl->tpl_vars['exchangeIteam']->value['create_time']==''){?>
                    <td style="text-align: center;">暂无</td>
                <?php }else{ ?>
                    <td style="text-align: center;"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['exchangeIteam']->value['create_time'],"%Y-%m-%d %H:%M");?>
</td>
                <?php }?>
