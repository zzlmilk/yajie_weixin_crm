<?php /* Smarty version Smarty-3.0-RC2, created on 2014-03-07 16:28:29
         compiled from "/web/www/weixin_crm//templates/left.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3481892905319832dd88f92-41643478%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '844c7de81288165761a8c208b58c48bfe3f691ae' => 
    array (
      0 => '/web/www/weixin_crm//templates/left.tpl',
      1 => 1394180908,
    ),
  ),
  'nocache_hash' => '3481892905319832dd88f92-41643478',
  'function' => 
  array (
  ),
                                ...
                                <td height="29" onclick="list('1')">
                                    <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="85%">
                                                <a href="javascript:vold(0)" target="mainFrame" class="left-font03" onclick="list('1')">用户管理</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
...
/slide.php?type=2" target="mainFrame" class="left-fontSmall" onclick="tupian('1')">312321</a>
                                </td>
                                ...
                                <td height="29" onclick="list('2')">
                                    <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="85%">
                                                <a href="javascript:vold(0)" target="mainFrame" class="left-font03" onclick="list('2')">积分管理</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
...
/slide.php?type=2" target="mainFrame" class="left-fontSmall" onclick="tupian('2')">111</a>
                                ...
                                <td height="29" onclick="list('3')">
                                    <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="85%">
                                                <a href="javascript:vold(0)" target="mainFrame" class="left-font03" onclick="list('3')">微游戏管理</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table id="subtree3" style="DISPLAY: none" width="95%" border="0" align="center" cellpadding="0" ellspacing="0" class="left-table03 tableDefault">
                            <tr>
                                ...
                                <td width="85%">
                                    <a href="<?php echo $_smarty_tpl->getVariable('URLCONTROLLER')->value;?>
/slide.php?type=2" target="mainFrame" class="left-fontSmall" onclick="tupian('3')">111</a>
                                </td>
