                ...
                {foreach from=$exchangeList item=exchangeItem key=key}
                    {if $key%2 eq 0}
                        ...
                        <td style="">
                            ...
                            <a  href="{$WebSiteUrl}?g=company&a=user&v=changeGoods&goodsId={$exchangeItem.exchange_id}&open_id={$open_id}"><button type="submit" class="btn btn-primary btn-xs">兑换</button></a>
