                   ...
                   <span style='font-size:15px; display: inline-block; width: 23%; height: 4%;  '>{$userinfo.weixin_user.nickname}</span>
                    ...
                    <span style='display:inline-block; position: relative; width: 25%'>
                        {if $userinfo.weixin_user.sex == 1}
                            ...
                            <img src='{$WebSiteUrlPublic}/company/image/nan.png'  style='width: 21px; height: auto; position: absolute; top: 2%;'>
                            <span class='siteClass' style='font-size:12px;position:relative; left: 37% '>男</span>
                            {elseif $userinfo.weixin_user.sex == 2}
                                <img src='{$WebSiteUrlPublic}/company/image/nv.png'  style='width: 21px; height: auto; position: absolute; top: 2%;'>
