...
<html>
    ...
    <body>
        ...
        <div class="cardBackground">
            ...
            <form id="orderForm" method='post' role="form" action="{$WebSiteUrl}?g={$model}&a=reserve&v=cancelOrder&toCancel=1">
    ...
    <script>
        ...
        $("#revise").click(function() {
            $("#orderForm").attr("action", webSiteUrl + "?g="+model+"&a=order&v=order&checkReturn=1&open_id=" + openId);
            $("#orderForm").submit();
        });
        $("#cancel").click(function() {
            $("#orderForm").attr("action", webSiteUrl + "?g="+model+"&a=order&v=cancelOrder&toCancel=1&open_id=" + openId);
            $("#orderForm").submit();
        });
