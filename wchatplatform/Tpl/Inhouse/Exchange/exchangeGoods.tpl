    ...
    <body>
        <div class="registerWarp">
            ...
            <div>
                ...
                <p><a href="{$WebSiteUrl}?g=Inhouse&a=exchange&v=changeGoods&goodsId={$exchangeInfo.exchange_id}&open_id={$open_id}"><button type="button" class="btn btn-primary btn-xs">兑换</button></a></p>
            </div>
        </div>
    </body>
</html>