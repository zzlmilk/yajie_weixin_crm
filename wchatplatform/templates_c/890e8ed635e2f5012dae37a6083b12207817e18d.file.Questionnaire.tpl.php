<?php /* Smarty version Smarty-3.0-RC2, created on 2014-03-25 13:21:27
         compiled from "/web/www/yajie_weixin_crm/wchatplatform/templates/Game/Questionnaire.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8518379953311257deb005-82936818%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '890e8ed635e2f5012dae37a6083b12207817e18d' => 
    array (
      0 => '/web/www/yajie_weixin_crm/wchatplatform/templates/Game/Questionnaire.tpl',
      1 => 1395724886,
    ),
  ),
  'nocache_hash' => '8518379953311257deb005-82936818',
  'function' => 
  array (
  ),
...
/company/script/jquery.form.js"></script>
    ...
    <boby>
            <div class="registerWarp">
                ...
                <form id='questionForm' class="form-horizontal"  method='post' role="form"  action="<?php echo $_smarty_tpl->getVariable('WebSiteUrl')->value;?>
?g=company&a=game&v=uploadQuestion" name='questionForm'>
...
.<?php echo $_smarty_tpl->tpl_vars['infos']->value['question_title'];?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['infos']->value['question_type']==0){?>
                                 ...
                                 <div class="col-sm-10">
                                   <input type="text" class="form-control"  placeholder="例如：张三" id='question_<?php echo $_smarty_tpl->tpl_vars['infos']->value['question_id'];?>
